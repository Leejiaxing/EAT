...
class SparseDispatcher(object):
    ...
    def dispatch(self, inp, edge_index, edge_attr):
        ...
        return torch.split(inp_exp, self._part_sizes, dim=0), torch.split(edge_index_exp, self._part_sizes,
                                                                          dim=1), torch.split(edge_attr_exp,
...
class MoE(nn.Module):
    ...
    def __init__(self, input_size, output_size, num_experts, experts_conv, noisy_gating=True, k=4,
                 coef=1e-2, num_experts_1hop=None):
    ...
    def forward(self, x, edge_index):
        ...
        for i in range(self.num_experts):
            expert_i_output = self.experts_conv[i](x, edge_index)
