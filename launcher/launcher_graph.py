...
class Launcher():
    ...
    def reset_launcher(self):
        ...
        # self.scheduler = torch.optim.lr_scheduler.CyclicLR(self.optimizer, base_lr=self.lr/10, max_lr=self.lr*10,step_size_up=5,mode="triangular2")
    ...
    def train_epoch(self, loader):
        ...
        for data in loader:
            ...
            if 'lpe' in data:
                sign_flip = torch.rand(data.lpe.size(1), device="cuda:0")
            ...
            loss = self.loss_metric_kit['loss_fn'](loss_pred, loss_true) + load_balance_loss
